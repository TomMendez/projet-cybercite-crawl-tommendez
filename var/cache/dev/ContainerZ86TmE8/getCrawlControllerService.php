 ...
 */
class getCrawlControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\CrawlController' shared autowired service.
     *
     * @return \App\Controller\CrawlController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/CrawlController.php';

        $container->services['App\\Controller\\CrawlController'] = $instance = new \App\Controller\CrawlController();
        ...
        ]))->withContext('App\\Controller\\CrawlController', $container));
